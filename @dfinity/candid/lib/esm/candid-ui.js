...
export const inputBox = (t, config) => {
  return new UI.InputBox(
    t,
    Object.assign(Object.assign({}, InputConfig), config),
  );
};
export const recordForm = (fields, config) => {
  return new UI.RecordForm(
    fields,
    Object.assign(Object.assign({}, FormConfig), config),
  );
};
export const tupleForm = (components, config) => {
  return new UI.TupleForm(
    components,
    Object.assign(Object.assign({}, FormConfig), config),
  );
};
export const variantForm = (fields, config) => {
  return new UI.VariantForm(
    fields,
    Object.assign(Object.assign({}, FormConfig), config),
  );
};
export const optForm = (ty, config) => {
  return new UI.OptionForm(
    ty,
    Object.assign(Object.assign({}, FormConfig), config),
  );
};
export const vecForm = (ty, config) => {
  return new UI.VecForm(
    ty,
    Object.assign(Object.assign({}, FormConfig), config),
  );
};
