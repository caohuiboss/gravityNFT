...
exports.createIdentityDescriptor =
  exports.AnonymousIdentity =
  exports.SignIdentity =
    void 0;
    ...
    return Object.assign(Object.assign({}, fields), {
      body: {
        ...
        sender_sig: await this.sign(
          buffer_1.concat(domainSeparator, requestId),
        ),
      },
    });
  }
  ...
  const identityIndicator =
    'getPublicKey' in identity
      ? {
          ...
          publicKey: buffer_1.toHex(identity.getPublicKey().toDer()),
        }
